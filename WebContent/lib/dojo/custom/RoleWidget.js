...
define([
    ...
    "dojox/form/Manager",
    "dojo/dom",
    "dojo/text!./UserWidget/template/RoleWidget.html"
    ...
    return declare("custom.RoleWidget", [_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin], {
        ...
        _initGrid: function(){
		    ...
		    //数据来源
		    var jsonStore = new JsonRest({target: "/iHome/pageRoles/", idProperty: "id"});
